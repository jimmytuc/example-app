...
describe('Pipe: Ellipsis', () => {
  ...
  const shortStr: string = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam ab similique, odio sit harum laborum rem, nesciunt atque iure a pariatur nam nihil dolore necessitatibus quos ea autem accusantium dolor voluptates voluptatibus. Doloribus libero, fa';
  beforeEach(() => {
  ...
  it('should return only 20 characters followed by an ellipsis', () => {
    expect(pipe.transform(longStr, 20)).toEqual('Lorem ipsum dolor si...');
  });
});
